export const secondaryOptions = {
  ...
  adopt: [
    {
      value: 'yes',
      label: 'adopt a Konvoy 1 cluster',
      usage: 'dkp adopt',
    }
  ],
  ...
  completion: [
    {
      value: 'yes',
      label: 'generate the autocompletion script for the specified shell',
      usage: 'dkp completion',
    }
  ],
  ...
  create: [
    {
      value: 'yes',
      label: 'create one of [bootstrap (resources), cluster]',
      usage: 'dkp create',
    }
  ],
  ...
  delete: [
    {
      value: 'yes',
      label: 'delete one of [bootstrap (resources), cluster, nodepool]',
      usage: 'dkp delete',
    }
  ],
  ...
  get: [
    {
      value: 'yes',
      label: 'get one of [kubeconfig, nodepools]',
      usage: 'dkp get',
    }
  ],
  ...
  move: [
    {
      value: 'yes',
      label: 'move controllers and objects from one cluster to the other',
      usage: 'dkp move',
    }
  ],
  ...
  preparetoadopt: [
    {
      value: 'yes',
      label: 'prepare to adopt a Konvoy 1 cluster',
      usage: 'dkp prepare-to-adopt',
    }
  ],
  ...
  update: [
    {
      value: 'yes',
      label: 'update one of [bootstrap (resources)]',
      usage: 'dkp update',
    }
  ],
